...
const QuickSuccess = () => {
  ...
  useEffect(() => {
    // Read and preserve full bill data
    const billData = JSON.parse(localStorage.getItem('quickBillData') || '{}');

    // Optional: Mark as paid via eSewa (already set in QuickEsewa)
    billData.paymentMethod = 'esewa';
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white rounded-xl shadow-lg p-12 text-center">
        <div className="w-20 h-20 bg-green-100 rounded-full flex items-center justify justify-center mx-auto mb-6">
