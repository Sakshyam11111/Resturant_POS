// src/components/pages/customerlogin/CustomerLogin.jsx
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 mt-2">Login in as Customer</p>
          </div>
          ...
          <p className="text-center text-sm text-gray-600 mt-6">
            New customer?{' '}
            <Link to="/customersignup" className="text-[#3673B4] font-semibold hover:underline">
              Create an account
            </Link>
          </p>
        </motion.div>
