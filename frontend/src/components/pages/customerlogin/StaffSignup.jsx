// src/components/pages/stafflogin/StaffSignup.jsx
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-gray-900">Staff Signup</h1>
          ...
          <p className="text-center text-sm text-gray-600 mt-6">
            ...
            <Link to="/stafflogin" className="text-[#3673B4] font-semibold hover:underline">
              Login here
            </Link>
          </p>
        </motion.div>
